...
const I18N = {
  zh: {
    ...
    model_picker_acp_source: 'ACP 会话配置',
    cancel: '取消',
    usage: '套餐用量',
    ...
    // v1.0.2: mcode 0.2.4 control surface
    fork_button: '分叉',
    fork_confirm: '从这里分叉？当前会话继续，新分支从这里开始',
    fork_success: '已分叉',
    fork_failed: '分叉失败',
    queue_button: '排队',
    queue_queued: '已加入队列，当前回复结束后发送',
    queue_badge: '排队中',
    queue_empty: '队列为空',
    queue_steer: '引导',
    queue_delete: '删除',
    queue_placeholder: '输入要排队的内容...',
    steer_button: '引导当前响应',
    steer_input_placeholder: '输入引导内容...',
    steer_notice: '已引导当前响应',
    resume_strategy_most_recent: '接续最近会话',
    mode_label: '模式',
    mode_default: '默认',
    mode_plan: 'Plan 模式',
    mode_accept_edits: '接受编辑',
    mode_bypass_permissions: '绕过权限',
    btn_plus_title: '更多操作',
    btn_plus_attach: '上传附件',
    btn_plus_mode: '模式',
    btn_plus_permission: '权限',
    btn_plus_model: '模型',
    runtime_loading: 'Runtime 正在启动...',
    runtime_not_ready: 'Runtime 尚未就绪，请稍候',
    // v1.0.2 Round 6: Goal / Delegation / Ask 倒计时
    goal_title: '目标',
    goal_budget_used: '已用',
    goal_budget_total: '上限',
    goal_budget_status_active: '进行中',
    goal_budget_status_paused: '已暂停',
    goal_budget_status_blocked: '阻塞',
    goal_budget_status_complete: '已完成',
    goal_budget_status_budget_limited: '预算用尽',
    goal_create_prompt: '新建目标',
    goal_objective_label: '目标描述',
    goal_objective_placeholder: '例如: 调研 mcode 0.2.4 控制面',
    goal_token_budget_label: 'Token 预算 (可选)',
    goal_create_btn: '创建',
    goal_clear_btn: '清空目标',
    goal_clear_confirm: '确定清空当前目标?',
    goal_complete_toast: '目标已完成',
    goal_budget_limited_toast: '目标预算用尽',
    delegation_card_title: '子任务',
    delegation_empty: '当前无活跃子任务',
    ask_countdown: '自动续接倒计时',
    ask_countdown_seconds: '{n} 秒',
  },
  en: {
    title: 'Mcode Web UI',
    new_chat: 'New Chat',
    ...
    model_picker_acp_source: 'ACP session config',
    cancel: 'Cancel',
    usage: 'Usage',
    ...
    // v1.0.2: mcode 0.2.4 control surface
    fork_button: 'Fork',
    fork_confirm: 'Fork from here? Current session continues; new branch starts here.',
    fork_success: 'Forked',
    fork_failed: 'Fork failed',
    queue_button: 'Queue',
    queue_queued: 'Queued — will send after the current reply',
    queue_badge: 'Queued',
    queue_empty: 'Queue is empty',
    queue_steer: 'Steer',
    queue_delete: 'Delete',
    queue_placeholder: 'Type to enqueue...',
    steer_button: 'Steer current response',
    steer_input_placeholder: 'Steering text...',
    steer_notice: 'Steered current response',
    resume_strategy_most_recent: 'Resume most recent',
    mode_label: 'Mode',
    mode_default: 'Default',
    mode_plan: 'Plan mode',
    mode_accept_edits: 'Accept edits',
    mode_bypass_permissions: 'Bypass permissions',
    btn_plus_title: 'More actions',
    btn_plus_attach: 'Upload attachment',
    btn_plus_mode: 'Mode',
    btn_plus_permission: 'Permission',
    btn_plus_model: 'Model',
    runtime_loading: 'Runtime is starting...',
    runtime_not_ready: 'Runtime not ready, please wait',
    // v1.0.2 Round 6: Goal / Delegation / Ask 倒计时
    goal_title: 'Goal',
    goal_budget_used: 'used',
    goal_budget_total: 'budget',
    goal_budget_status_active: 'Active',
    goal_budget_status_paused: 'Paused',
    goal_budget_status_blocked: 'Blocked',
    goal_budget_status_complete: 'Complete',
    goal_budget_status_budget_limited: 'Budget limited',
    goal_create_prompt: 'New Goal',
    goal_objective_label: 'Objective',
    goal_objective_placeholder: 'e.g. investigate mcode 0.2.4 control surface',
    goal_token_budget_label: 'Token budget (optional)',
    goal_create_btn: 'Create',
    goal_clear_btn: 'Clear goal',
    goal_clear_confirm: 'Clear current goal?',
    goal_complete_toast: 'Goal complete',
    goal_budget_limited_toast: 'Goal budget limited',
    delegation_card_title: 'Delegations',
    delegation_empty: 'No active delegations',
    ask_countdown: 'Auto-resume in',
    ask_countdown_seconds: '{n}s',
  }
}
