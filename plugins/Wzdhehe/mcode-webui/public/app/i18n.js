...
const I18N = {
  zh: {
    ...
    lan_card_interfaces: '允许的接口',
    lan_card_interface_help: '不勾选 = 全部允许（默认）；勾选 = 仅限这些网卡',
    lan_card_interfaces_all: '当前: 全部允许 (默认)',
    lan_card_interfaces_some: '当前: 仅限以下接口',
    lan_card_interface_no: '无可枚举的网卡',
  ...
  en: {
    ...
    lan_card_interfaces: 'Allowed interfaces',
    lan_card_interface_help: 'None checked = allow all (default); check = limit to these',
    lan_card_interfaces_all: 'Currently: allow all (default)',
    lan_card_interfaces_some: 'Currently: limit to these',
    lan_card_interface_no: 'No enumerable interfaces',
