...
before(async (t) => {
  ...
  // only exercise the pure parser. makeClientState/pushStateFor and
  // the settings mock accessors are intentionally not destructured —
  // re-add them if a test switches to the full query path.
});
